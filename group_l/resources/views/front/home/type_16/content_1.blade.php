<div class="type_16">
	<div class="type_16_content">
		<div class="vc_row wpb_row vc_row-fluid content-padding-xxl vc_custom_1456180226251 vc_row-has-fill vc_general vc_parallax vc_parallax-content-moving parallax-container">
			...
			<img src="images/photo3.jpg" alt="" class="hidden-xs parallax-image pt3">
			<img src="images/photo2.jpg" alt="" class="hidden-xs parallax-image pt2">
			<img src="images/photo1.jpg" alt="" class="hidden-xs parallax-image pt1">
