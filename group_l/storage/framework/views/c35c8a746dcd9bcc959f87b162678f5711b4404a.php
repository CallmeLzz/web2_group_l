<div class="type_16">
	<div class="detail">
		<div class="type_16_junior_suite">
			...
			<?php if(isset($type_5)): ?>
				<?php $__currentLoopData = $type_5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
							...
							<div class="wpb_text_column wpb_content_element white-box content-padding">
								<div class="wpb_wrapper">
									<h2 class="text-uppercase" style="text-align: left;">
										...
										<?php echo e(strtoupper($value->category_title)); ?>
